      ...
      >
        ...
        >
          ...
          <div className="p-6 overflow-y-auto text-surface-400 space-y-4 text-sm leading-relaxed">
            ...
            <p className="pt-4 border-t border-white/5 mt-4">Si tiene alguna pregunta sobre esta Política de Privacidad, por favor contáctenos en info@multigymcr.com.</p>
          </div>
        </motion.div>
      </div>
    </AnimatePresence>
